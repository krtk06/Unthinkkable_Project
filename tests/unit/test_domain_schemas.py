...
from app.domain.match import Evidence, MatchResult
from app.domain.resume import Education, Experience, ExtractedResume
...
def test_resume_schema_rejects_unknown_fields() -> None:
    with pytest.raises(ValidationError):
        ExtractedResume(unexpected="value")


def test_experience_rejects_invalid_date() -> None:
    with pytest.raises(ValidationError):
        Experience(start_date="January 2020", description="Worked")
